...
var WhattodoifPageModule = /** @class */ (function () {
    function WhattodoifPageModule() {
    }
    WhattodoifPageModule = __decorate([
        NgModule({
            declarations: [
            //    WhattodoifPage,
            ],
    ...
    return WhattodoifPageModule;
}());
export { WhattodoifPageModule };
//# sourceMappingURL=whattodoif.module.js.map